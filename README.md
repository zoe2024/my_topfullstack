<!--
 * @Author: yuan.zhou
 * @Date: 2021-02-08 14:06:17
 * @Descripton: 项目说明 
 * @LastEditTime: 2021-06-14 11:08:14
-->
# my_topfullstack
《全栈之巅》demo；技术【NodeJs+vue2Js+mongodb】

## 说明
  这个项目的目标在于属性一个完整项目的从开始到上线的全流程，包含node后端服务、系统管理后台pc端、web展示app端

# 【全栈之巅】Node.js + Vue.js 全栈开发王者荣耀手机端官网和管理后台
> 本项目是 [Bilibili 全栈之巅](https://space.bilibili.com/341919508) 视频教程编写的
